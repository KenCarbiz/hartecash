...
PROTECTED_ENDPOINTS: list[tuple[str, str, dict | None]] = [
    ...
    ("GET", "/tcpa/quiet-hours", None),
    ("PUT", "/tcpa/quiet-hours", {"start": "09:00", "end": "18:00"}),
    ...
    ("POST", "/leads/1/seen", None),
    # First-run onboarding checklist
    ("GET", "/onboarding/checklist", None),
    ...
    (
        "POST",
        "/voice/bridge",
        {"lead_id": 1, "rep_phone": "(813) 555-7777"},
    ),
    ...
    # Cross-lead activity log
    ("GET", "/analytics/activity", None),
    # Lead routing config
    ("GET", "/routing", None),
